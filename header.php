...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class( array( "page-template-template-full-width", "page-template-templatestemplate-full-width-php", "has-full-width-content enable-search-modal", "template-full-width" ) ); ?> >
					...
					<div class="header-titles-wrapper">
						...
						<div class="header-titles" id="header-logo-wrapper">
							...
							<?php
								...
								echo '<a href="/" title="Triangle Research Libraries Network"><span class="sr-only">Triangle Research Libraries Network</span></a>';
